...
const DEFAULT_AGENT_ICONS: Record<RoomAgent['agent'], string> = {
    hermes: getPublicAssetUrl('/coding-agents/hermes.png'),
    ekko: getPublicAssetUrl('/coding-agents/ekko-agent.png'),
    codex: getPublicAssetUrl('/coding-agents/codex-openai.png'),
    claude: getPublicAssetUrl('/coding-agents/claude-code.svg'),
    pi: getPublicAssetUrl('/coding-agents/pi.svg'),
}
