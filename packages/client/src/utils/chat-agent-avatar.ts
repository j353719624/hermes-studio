...
const AGENT_AVATARS = {
  hermes: { label: 'Hermes', src: getPublicAssetUrl('/coding-agents/hermes.png') },
  'ekko-agent': { label: 'Ekko', src: getPublicAssetUrl('/coding-agents/ekko-agent.png') },
  'claude-code': { label: 'Claude', src: getPublicAssetUrl('/coding-agents/claude-code.svg') },
  codex: { label: 'Codex', src: getPublicAssetUrl('/coding-agents/codex-openai.png') },
  pi: { label: 'Pi', src: getPublicAssetUrl('/coding-agents/pi.svg') },
