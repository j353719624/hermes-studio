...
const emptyStateAgents = [
    { name: 'Hermes', src: getPublicAssetUrl('/coding-agents/hermes.png') },
    { name: 'Ekko', src: getPublicAssetUrl('/coding-agents/ekko-agent.png') },
    { name: 'Codex', src: getPublicAssetUrl('/coding-agents/codex-openai.png') },
    { name: 'Claude', src: getPublicAssetUrl('/coding-agents/claude-code.svg') },
]
