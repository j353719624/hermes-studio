...
import { isFnosMode, isStoredSuperAdmin } from "@/api/client";
        ...
        <div class="header-actions">
          ...
          <template v-if="currentMode === 'chat'">
            <NTooltip v-if="isSuperAdmin" trigger="hover">
              ...
              {{ fnosMode ? t("drawer.files") : desktopBrowserAvailable ? `${t("drawer.files")} / ${t("drawer.terminal")} / ${t("browser.title")}` : `${t("drawer.files")} / ${t("drawer.terminal")}` }}
            </NTooltip>
