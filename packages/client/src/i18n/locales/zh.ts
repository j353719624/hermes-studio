export default {
  browser: {
    ...
    fnosConfigHint: '飞牛 OS 版本只管理浏览器配置，不在 Studio 内嵌浏览器；配置文件和目录保存在飞牛 NAS 上。', fnosConfigOnly: '当前为配置模式，下载记录由外部浏览器管理。', fnosPermissionsHint: '当前为配置模式，网站权限由外部浏览器管理；Studio 不会打开网页或保存浏览器画面。', fnosConfigLoadFailed: '加载浏览器配置失败', fnosConfigSelectRootFailed: '选择飞牛配置目录失败', fnosChooseProfileRootDirectory: '选择飞牛配置目录', fnosProfileRootDirectoryHint: '可选择飞牛上的可写目录。浏览器数据使用 {data}，下载文件使用 {download}；不填写时使用应用数据目录。',
  },
  // 登录
  login: {
    title: 'Hermes Studio',
  ...
  sidebar: {
    ...
    hermesAgentUpgrade: '升级 Hermes Agent',
  ...
  fnosRuntimeUpdate: {
    title: '升级 Hermes Agent',
    currentVersion: '当前版本',
    platform: '平台',
    latest: '最新',
    upgrade: '立即升级',
    noUpdates: '当前已是可用的最新版本',
    remoteLoadFailed: '官方版本列表加载失败',
    restartDescription: '升级会下载并校验官方 Runtime，切换成功后自动重启 Hermes Studio。工作区和配置数据会保留。',
    taskTitle: '升级任务：{version}',
    started: '已开始升级，完成后服务会自动重启',
    restartPending: 'Runtime 已切换，Hermes Studio 正在重启。',
    stage: {
      resolve: '正在解析官方 Runtime',
      download: '正在下载 Runtime',
      verify: '正在校验 Runtime',
      extract: '正在解压 Runtime',
      install: '正在安装 Runtime',
      restart: '准备重启服务',
      completed: '升级完成',
      failed: '升级失败',
    },
  ...
  chat: {
    ...
    folderPickerSelectFnos: '选择飞牛 OS 目录',
    folderPickerSelect: '选择目录',
    folderPickerSelectFailed: '选择飞牛 OS 目录失败',
    workspaceSet: '工作区已设置',
  ...
  skills: {
    ...
    importHintFnosFolder: '从飞牛 OS 选择技能文件夹（需含 SKILL.md）',
    ...
    importSelectFnosFolder: '选择飞牛 OS 技能目录',
    importSelectFolderFailed: '选择飞牛 OS 技能目录失败',
    ...
    externalDirs: {
      ...
      fnosHint: '从飞牛 OS 选择已授权的技能目录，应用只会读取已授权范围。',
      add: '添加外部目录',
      selectTitle: '选择飞牛 OS 技能目录',
      select: '选择目录',
      selectFailed: '选择飞牛 OS 目录失败',
  ...
  codingAgents: {
    ...
    fnosUnavailable: "fnOS 便携版当前仅提供 Hermes 和 Ekko；外部 Coding Agent 需要额外的本机 CLI 与终端环境。",
