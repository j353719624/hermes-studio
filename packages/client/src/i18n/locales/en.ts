export default {
  browser: {
    ...
    fnosConfigHint: 'The fnOS build manages browser configuration only. Studio does not embed a browser; configuration files and directories stay on the NAS.', fnosConfigOnly: 'Configuration mode is active. Download history is managed by the external browser.', fnosPermissionsHint: 'Configuration mode is active. Site permissions are managed by the external browser; Studio does not open pages or store browser frames.', fnosConfigLoadFailed: 'Failed to load browser configuration', fnosConfigSelectRootFailed: 'Failed to choose the fnOS configuration directory', fnosChooseProfileRootDirectory: 'Choose an fnOS configuration directory', fnosProfileRootDirectoryHint: 'Choose a writable directory on fnOS. Browser data uses {data}; downloads use {download}. If empty, the app data directory is used.',
  },
  // Login
  login: {
    title: 'Hermes Studio',
  ...
  sidebar: {
    ...
    hermesAgentUpgrade: 'Upgrade Hermes Agent',
  ...
  fnosRuntimeUpdate: {
    title: 'Upgrade Hermes Agent',
    currentVersion: 'Current version',
    platform: 'Platform',
    latest: 'Latest',
    upgrade: 'Upgrade now',
    noUpdates: 'You are already using the latest available version',
    remoteLoadFailed: 'Failed to load the official version list',
    restartDescription: 'The official Runtime is downloaded and verified, then Hermes Studio restarts automatically. Workspace and configuration data are preserved.',
    taskTitle: 'Upgrade task: {version}',
    started: 'Upgrade started. The service will restart when it is ready.',
    restartPending: 'Runtime switched. Hermes Studio is restarting.',
    stage: {
      resolve: 'Resolving official Runtime',
      download: 'Downloading Runtime',
      verify: 'Verifying Runtime',
      extract: 'Extracting Runtime',
      install: 'Installing Runtime',
      restart: 'Preparing service restart',
  ...
  chat: {
    ...
    folderPickerSelectFnos: 'Choose fnOS folder',
    folderPickerSelect: 'Choose folder',
    folderPickerSelectFailed: 'Failed to choose fnOS folder',
  ...
  skills: {
    ...
    importHintFnosFolder: 'Pick a skill folder from fnOS (must contain SKILL.md)',
    ...
    importSelectFnosFolder: 'Choose fnOS skill folder',
    importSelectFolderFailed: 'Failed to choose fnOS skill folder',
    ...
    externalDirs: {
      ...
      fnosHint: 'Choose an authorized skill directory from fnOS. The app reads only authorized paths.',
      add: 'Add external dir',
      selectTitle: 'Choose fnOS skill directory',
      select: 'Choose directory',
      selectFailed: 'Failed to choose fnOS directory',
  ...
  codingAgents: {
    ...
    fnosUnavailable: "The portable fnOS build currently provides Hermes and Ekko only; external coding agents require their own local CLI and terminal environment.",
