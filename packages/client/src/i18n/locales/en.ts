export default {
  browser: {
    ...
    fnosAddressPlaceholder: 'Enter a URL and press Enter', fnosConnected: 'NAS Chrome connected', fnosConnecting: 'Connecting to NAS Chrome', fnosStarting: 'Detecting NAS Chrome…', fnosStreamFailed: 'Failed to connect to the NAS Chrome view', fnosLocalHint: 'The browser runs in Chrome/Chromium on fnOS and uses the existing browser tabs on the NAS.', fnosClose: 'Close current tab', fnosClosed: 'Current tab closed',
  },
  // Login
  login: {
    title: 'Hermes Studio',
