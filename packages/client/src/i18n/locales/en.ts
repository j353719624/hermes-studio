export default {
  browser: {
    ...
    fnosAddressPlaceholder: 'Enter a URL and press Enter', fnosConnected: 'Local browser connected', fnosConnecting: 'Connecting to the local browser', fnosStarting: 'Starting the local browser…', fnosStreamFailed: 'Failed to connect to the local browser view', fnosLocalHint: 'The browser runs on this fnOS device and stores data in the application data directory.', fnosClose: 'Close browser', fnosClosed: 'Local browser closed',
  },
  // Login
  login: {
    title: 'Hermes Studio',
