...
import { normalizeMessageContentForStorageRole } from '../../../db/hermes/message-content'
import {
    AgentClients,
...
import { isFnosGatewayRequestAllowed } from '../../../middleware/fnos-gateway'
    ...
    constructor(httpServers: HttpServer | HttpServer[]) {
        ...
        this.io = new Server(servers[0], {
            ...
            allowRequest: (req, callback) => {
                if (!isFnosGatewayRequestAllowed(req)) {
                    callback('fnOS administrator access required', false)
                    return
                }
